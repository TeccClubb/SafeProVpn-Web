...
const DownloadForAndroid: FC = () => (
  <>
    ...
    >
      <div className="w-full lg:w-2/3 flex flex-col md:items-start gap-6">
        <SectionHeading className="md:text-start mb-0">
          Download SafePro VPN for Android
        </SectionHeading>
        <SectionDescription className="lg:w-3/4 md:text-start p-0 mb-0">
          Secure your Android device with military-grade encryption. Enjoy
          private browsing, access geo-restricted content, and keep your data
        ...
        {[
          {
            ...
            description:
              'Visit the Play Store and search for "SafePro VPN" or click the download button above.',
            Icon: AndroidIcon,
          },
          {
    ...
    <Section
      heading={
        <>
          <span className="text-primary">SafePro VPN</span> Android App
        </>
      }
    >
    ...
    >
      <Accordion variant="splitted" className="w-full max-w-xl mb-4">
        {[
          {
            question: "Is SafePro VPN compatible with all Android devices?",
            answer:
              "Yes, SafePro VPN is compatible with most Android smartphones and tablets running Android 7.0 (Nougat) or later. For the best performance and security, we recommend using the latest version of Android.",
          },
          {
...
export default DownloadForAndroid;

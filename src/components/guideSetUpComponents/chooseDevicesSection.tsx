        ...
        >
            <div className="max-w-6xl mx-auto  grid md:grid-cols-2  rounded-lg shadow-md bg-white">
                ...
                <div className="bg-white p-5">
                    <h2 className="text-xl text-left font-semibold mb-4">Choose Your Device</h2>
                    <p className="text-gray-600 mb-4 text-left">
                        SafePro VPN works on all your devices. Select your platform to get started.
                    </p>
                    <div className="grid text-black grid-cols-3 gap-4 pt-2">
                        {[
                            ...
                            <Button key={name} className="bg-white duration-300  border    text-gray-800 hover:bg-cyan-300 hover:text-cyan-700   rounded-lg flex items-center justify-start gap-2  border-gray-300 ">
                                <Icon />
                                {name}
                            </Button>
                        ))}
